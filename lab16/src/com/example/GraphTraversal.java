...
public class GraphTraversal {
    public static void setNonOriented(GraphOriented graph) {
    ...
    public static Set<Integer> depthFirstTraversal(GraphOriented graph, int root) {
        if (graph.isOriented()) {
    ...
    public static Set<Integer> breadthFirstTraversal(GraphOriented graph, int root) {
        if (graph.isOriented()) {
            setNonOriented(graph);
        }
